    ...
    implements IDecorator, ICrud, ICrudPlus
{
    ...
    getOptions(): object {
        if (
            this._$target &&
            (this._$target as unknown as OptionsMixin).getOptions
        ) {
    ...
    setOptions(options: object): void {
        if (
            this._$target &&
            (this._$target as unknown as OptionsMixin).setOptions
        ) {
            return (this._$target as unknown as OptionsMixin).setOptions(
                options
            );
        }
        throw new TypeError(
            'Option "target" should be an instance of Types/_source/OptionsMixin'
        );
    }
    ...
    _getSerializableState(
        state: ISerializableState
    ): IPrefetchProxySerializableState {
        const resultState = super._getSerializableState(
            state
        ) as IPrefetchProxySerializableState;
    ...
    protected _checkDataOptions(data: IData): void {
        ...
        if (data.query) {
            if (
                !data.query['[Types/_source/DataSet]'] &&
                !(data.query instanceof Error)
            ) {
                logger.info(
