...
export default class DataSet<
    ...
    TList extends RecordSet<TData, Record<TData>> = RecordSet<
        TData,
        Model<TData>
    >,
...
> extends mixin<DestroyableMixin, OptionsToPropertyMixin, SerializableMixin>(
    ...
    getAll(property?: TItemsProperty): TList {
        ...
        if (
            this._$metaProperty &&
            (items as RecordSet).getMetaData instanceof Function
        ) {
            ...
            if (
                !someInMetaData &&
                this._$rawData &&
                (this._$rawData as unknown as IRawDataWithTotal).total
            ) {
                metaData = {
                    total: (this._$rawData as unknown as IRawDataWithTotal)
                        .total,
                };
                someInMetaData = true;
            }
            ...
            if (someInMetaData) {
                ...
                if (
                    !itemsMetaData.hasOwnProperty('more') &&
                    metaData.hasOwnProperty('total')
                ) {
    ...
    getMetaData(): TRawData[TMetaProperty] {
        return (
            (this._$metaProperty &&
                this._getDataProperty(this._$metaProperty)) ||
    ...
    hasProperty(property?: string): boolean {
        return property
            ? this._getDataProperty(property as never) !== undefined
            : false;
    }
    ...
    getProperty<K extends keyof TRawData>(
        property?: K
    ): TRawData[K] | TRawData {
        return this._getDataProperty<K>(property);
    }
     ...
     * @protected
     */
    protected _getDataProperty<K extends keyof TRawData>(
        property: K
    ): TRawData[K] {
        this._checkAdapter();
        return property
