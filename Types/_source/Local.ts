    ...
    implements ICrud, ICrudPlus
{
    ...
    update(data: Record | RecordSet, _?: object): Promise<void> {
    ...
    protected _applyWhere(data: any, where?: WhereExpression<unknown>, meta?: IMeta): any {
        ...
        const checkFields = (fields: string[], item: any) => {
            let result = true;
    ...
    protected _reorderMove(
        ...
        if (!meta.position && meta.hasOwnProperty('before')) {
            meta.position = meta.before ? LOCAL_MOVE_POSITION.Before : LOCAL_MOVE_POSITION.After;
        }
    ...
    static es5Constructor(options?: IOptions): void {
        ...
        Local.prototype._reIndex.call(this, options);
    }
}
