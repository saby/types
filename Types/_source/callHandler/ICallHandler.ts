 ...
 * @remark Обработчик сообщений поддерживается только в провайдере {@link Browser/Transport:RPCJSON}
 * @see Types/source:RPCRequestParam
 * @see Browser/Transport:RPCJSON
 * @see Types/source:SbisService:callHandlers
 * @public
 * @example
