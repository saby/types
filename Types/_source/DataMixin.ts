...
export interface IOptions {
    /**
     * Адаптер для работы данными, по умолчанию {@link Types/entity:adapter.Json}
     */
    adapter?: string | adapter.IAdapter;
    /**
     * Конструктор записей, порождаемых источником. По умолчанию {@link Types/entity:Model}.
     */
    ...
    keyProperty?: string;
    /**
     * Название свойства в {@link Types/source:DataSet}, содержащего мета-данные.
     */
