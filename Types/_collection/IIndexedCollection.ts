...
export default interface IIndexedCollection {
     ...
     * </pre>
     * @returns индекс первого элемента с указанным значением свойства. -1 если ничего не найдено.
     */
     ...
     * </pre>
     * @return массив индексов элементов, совпадающих с указанным значением свойства. Пустой массив, если ничего не найдено.
     */
