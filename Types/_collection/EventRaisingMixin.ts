...
class EventRaisingMixin {
    ...
    setEventRaising(enabled: boolean, analyze?: boolean): void {
        EntityEventRaisingMixin.prototype.setEventRaising.call(
            this,
            enabled,
            analyze
        );
    ...
    protected _startUpdateSession(): ISession {
        ...
        return enumerableComparator.startSession(
            this as any,
            this._sessionItemContentsGetter
        );
    }
     ...
     * @param [analyze=true] Запустить анализ изменений
     * @protected
     */
    protected _finishUpdateSession(session: ISession, analyze?: boolean): void {
        ...
        enumerableComparator.finishSession(
            session,
            this as any,
            this._sessionItemContentsGetter
        );
    ...
    protected _isNeedNotifyCollectionChange(): boolean {
        return (
            this._eventRaising && this.hasEventHandlers('onCollectionChange')
        );
    }
