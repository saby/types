 ...
 * @description Используется в {@link Types/entity:IRecordOptions#format} и {@link Types/collection:IRecordSetOptions#format} для конструирования формата полей по декларативному описанию, заданному пользователем.
 * @example
 ...
 * </pre>
 * @see {@link Types/entity:IRecordOptions#format}
 * @see {@link Types/entity:IModelOptions#format}
 * @see {@link Types/collection:IRecordSetOptions#format}
 * @param declaration Декларативное описание
 * @returns Объект с форматом полей
 */
