...
export class Meta<RuntimeInterface> {
    ...
    designtimeEditor<EditorProps extends IControlDesignerProps<RuntimeInterface>>(
        ...
        const newLoader = typeof loader !== 'string' ? loader : () => loadAsync(loader);

        return this.clone({
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            designtimeEditor: { loader: newLoader, props, isAlwaysShow },
        });
    }
    ...
    editor<EditorProps extends IPropertyEditorProps<RuntimeInterface>>(
        ...
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        return this.clone({ editor: { loader: newLoader, props } });
    }
