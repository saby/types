...
> extends ObjectMeta<T, ComponentPropsInterface> {
    ...
    constructor(
        ...
        this._valueConverterInput = this._createValueConverter<ValueConverterInputType>(
            descriptor,
            WidgetMeta.KEY_VALUE_CONVERTER_INPUT
        );
        this._valueConverterOutput = this._createValueConverter<ValueConverterOutputType>(
            descriptor,
    ...
    relatedObjects(relatedObjects: string[]): this {
        return this.clone<this, IWidgetMeta<ComponentPropsInterface>>({ relatedObjects });
    }
    ...
    private _createValueConverter<FS extends ValueConverterOutputType | ValueConverterInputType>(
        descriptor: IWidgetMeta<ComponentPropsInterface>,
        converterKey: string
    ) {
        ...
        return new ValueConverter({ loader, func });
    }
    ...
    valueConverterOutput(loader?: ValueConverterLoader<ValueConverterOutputType> | string) {
        ...
        let newLoader: ValueConverterLoader<ValueConverterOutputType>;
        ...
        return this.clone<this, IWidgetMeta<ComponentPropsInterface>>({
            valueConverterOutput: { loader: newLoader },
        });
    }
    ...
    valueConverterInput(loader: ValueConverterLoader<ValueConverterInputType> | string) {
        ...
        let newLoader: ValueConverterLoader<ValueConverterInputType>;
        if (typeof loader === 'string') {
            newLoader = () => loadAsync(loader);
        } else {
            newLoader = loader;
        ...
        return this.clone<this, IWidgetMeta<ComponentPropsInterface>>({
            valueConverterInput: { loader: newLoader },
        });
    }
