...
type TVariantMeta = Meta<unknown> | ArrayMeta<unknown> | ObjectMeta<unknown> | WidgetMeta<unknown>;

const baseIds = ['unknown', 'any', 'void', 'null', 'undefined',
    'boolean', 'number', 'string', 'object', 'promise', 'function'];
/**
 * Сериализация meta
...
function getAttachedMetaJson(attrObject: Record<string, Record<string, TVariantMeta>>):
