...
/**
 * Интерфейс состояния хеширования
 * @public
 */
...
/**
 * Утилита для свертки входного массива любого размера в битовую строку MD5.
 * @remark основано на [js-md5]{@link https://github.com/emn178/js-md5}
 */
export class Md5 {
    /**
     * Хеширует строку UTF-8 по месту
     * @param str Входная строка
     * @param raw Вернуть результат как `Int32Array`
     */
    ...
    /**
     * Хеширует строку ASCII по месту
     * @param str Входная строка
     * @param raw Вернуть результат как `Int32Array`
     */
    ...
    /**
     * Инициализировать буфер для хеширования
     */
    start() {
        this._dataLength = 0;
    ...
    /**
     * Добавляет UTF-8 строку в буфер для хеширования
     * @param str Входная строка
     */
    ...
    /**
     * Добавляет ASCII строку в буфер для хеширования
     * @param str Входная строка
     */
    ...
    /**
     * Добавляет Uint8Array в буфер для хеширования
     * @param input
     */
    ...
    /**
     * Получить состояние буфера хеширования
     */
    ...
    /**
     * Переопределить состояние буфера хеширования
     * @param state
     */
    setState(state: HasherState) {
    ...
    /**
     * Хеширует текущее состояние буфера и возвращает результат
     * @param raw Вернуть результат как `Int32Array`
     */
