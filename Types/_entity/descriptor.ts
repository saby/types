...
type ValidateFunc = <T>(props: T, propName: keyof T, componentName: string) => Error | undefined;
 ...
 * @param {unknown[]} values Допустимые значения.
 * @example
 ...
 * @param {unknown[]} values Allowed values
 * @example
 ...
 * @param {Descriptor} type Тип дескриптора.
 * @example
