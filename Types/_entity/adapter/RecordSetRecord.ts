...
import { IHashMap, EntityMarker, FormatNameMarker } from 'Types/declarations';
    ...
    implements IRecord
{
     ...
     * Таблица
     */
    protected _tableData: RecordSet | undefined;
    ...
    getTableData(): RecordSet | undefined {
    ...
    protected _touchData(): void {
        ...
        if (this._tableData && this._tableData['[Types/_entity/FormattableMixin]']) {
