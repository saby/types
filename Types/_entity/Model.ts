 ...
 * <ul>
 *    <li>определение {@link Types/entity:Model#getProperties собственных свойств} сущности;</li>
 *    <li>{@link Types/entity:Model#getKeyProperty уникальный идентификатор сущности} среди ей подобных.</li>
 * </ul>
 *
 * Поведенческие аспекты каждой сущности реализуются ее прикладным модулем в виде публичных методов.
 * Прикладные модели могут внедряться в порождающие их объекты, такие как {@link Types/source:Base#getModel источники данных} или {@link Types/collection:RecordSet#getModel рекордсеты}.
 *
 ...
 * <pre>
 *     import { Model, adapter, IModelProperty } from 'Types/entity';
 *
 *     class MyEngine extends Model {
 *         protected _$properties: Record<string, IModelProperty<MyEngine>>  = {
 *             fuelType: {
 *                 get() {
 *                     return 'Diesel';
 *                 }
 ...
 *         protected _$properties: Record<string, IModelProperty<MyTransmission>>  = {
 *             transmissionType: {
 *                 get() {
 *                     return 'Manual';
 *                 }
    ...
    implements IStateful
{
     ...
     *         protected _nickname: string;
     *         protected _$properties: Record<string, IModelProperty<Avenger>> = {
     *             nickname: {
     *                 get: function(): string {
     *                     return this._nickname;
     *                 }
     ...
     * </pre>
     */
    protected _$properties: Record<string, IProperty<any>>;
     ...
     * </pre>
     */
    getProperties(): Record<string, IProperty<any>> {
    ...
    protected _processCalculatedValue(
        name: string,
        value: any,
        method: IPropertyGetter<any, unknown>,
        isReading?: boolean
    ): any {
