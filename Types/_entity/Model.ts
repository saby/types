 ...
 * @public
 */
class Model<DeclaredType extends object = any> extends OurRecord<DeclaredType> implements IStateful {
    ...
    set<K extends keyof DeclaredType>(
        ...
        if (!hasCalculating && changedProperties) {
            const changed = Object.keys(changedProperties).reduce((memo: Record<string,any>, key) => {
