...
export default interface IStateful {
     ...
     * @param cascade Распространять изменения рекурсивно по вложенным элементам. Если параметр задан, будут вызваны acceptChanges рекурсивно у всех дочерних элементов. Игнорируется для типов Flags и Enum.
     */
     ...
     * @param cascade Отменить изменения всех дочерних элементов рекурсивно. Если параметр задан, будут вызваны rejectChanges рекурсивно у всех дочерних элементов. Игнорируется для типов Flags и Enum.
     */
