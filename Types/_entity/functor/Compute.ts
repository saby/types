 ...
 * Необходимо дополнительно использовать функтор {@link Types/entity:functor.Track Track} для отслеживания изменения {@link Types/entity:Model#getProperties собственных} свойств модели.
 * @example
