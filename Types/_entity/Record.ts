...
import IObject, { TRecMapped } from './IObject';
...
import { ExtendDate, IExtendDateConstructor, EntityMarker, IObjectKey } from '../_declarations';
        ...
        IStateful
{
    ...
    protected get _fieldsCache(): Map<string, any> {
        return this[$fieldsCache] || (this[$fieldsCache as string] = new Map());
    }
     ...
     * @protected
     */
    protected _getHashMap<T>(name: IObjectKey | Partial<T>, value?: T): Partial<T> {
        let map = name;
