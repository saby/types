        ...
        ITyped
{
     ...
     * </pre>
     */
    getEnumerator(): enumerator.Arraywise<keyof DeclaredType> {
        return create<enumerator.Arraywise<keyof DeclaredType>>(
     ...
     * </pre>
     */
    getOriginal<K extends keyof DeclaredType>(
        name: K
    ): K extends keyof DeclaredType ? DeclaredType[K] : unknown {
    ...
    each(callback: EnumeratorCallback<any>, context?: object): void {
        ...
        let name: keyof DeclaredType | undefined;
        while (enumerator.moveNext()) {
     ...
     */
    protected _getHashMap<T extends IHashMap<any> = IHashMap<any>>(
        name: keyof DeclaredType | Partial<T>,
        value?: DeclaredType[keyof DeclaredType]
    ): Partial<T> {
        let map = name;
