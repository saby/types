...
export default abstract class OptionsToPropertyMixin {
    readonly '[Types/_entity/OptionsToPropertyMixin]': EntityMarker = true;
    /**
            ...
            if (name.substr(0, optionPrefixLen) === optionPrefix) {
                ...
                if (proto[name] && proto[name][$mergeable]) {
                    ...
                    options[optionName] = Object.keys(value)
                        ...
                        .reduce((memo: Record<string, unknown>, propName) => {
...
Object.assign(OptionsToPropertyMixin.prototype, {
    '[Types/_entity/OptionsToPropertyMixin]': true,
});
