 ...
 * @author Буранов А.Р.
 */
export default function <T extends Field = Field>(
        ...
        switch (type.toLowerCase()) {
            ...
            case 'real':
                return new RealField(
                    declaration as IRealFieldOptions
                ) as unknown as T;
            case 'money':
                return new MoneyField(
                    declaration as IMoneyFieldOptions
                ) as unknown as T;
            case 'string':
    ...
    if (typeof type === 'function') {
        ...
        if (
            inst['[Types/_entity/IObject]'] &&
            inst['[Types/_entity/FormattableMixin]']
        ) {
            // Yes it's Types/_entity/Record
            return new RecordField(declaration) as T;
        } else if (
            inst['[Types/_collection/IList]'] &&
            inst['[Types/_entity/FormattableMixin]']
        ) {
