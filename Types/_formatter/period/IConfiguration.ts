...
export default interface IPeriodConfiguration {
    ...
    full: IPeriodFormats;
    /**
     * Набор форматов без сокращений и без года, если это один год.
     */
    fullWithoutYear: IPeriodFormats;
    /**
     * Набор форматов с сокращёнными названиями и без года, если это один год.
     */
    shortWithoutYear: IPeriodFormats;
}
...
export enum PeriodType {
    ...
    /**
     * Строковый шаблон, когда кварталы в одном году.
     */
