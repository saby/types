...
import { type PeriodTypeName } from './_period/IConfiguration';
...
function getDateFormat(start: Date, finish: Date): PeriodTypeName {
...
/**
 * Функция вычислет тип периода.
 * @param start Даты старта периода
 * @param finish Даты конца периода
 */
export default function detectPeriodType(start: Date, finish: Date): PeriodTypeName {
