 ...
 */
type TransformerCallback = (expression: string) => string | number;
 ...
 */
function resolve(expression: string, scope: Record<string, string | number>): string | number {
 ...
 * @public
 */
export default function template(str: string, scope: Record<string, string | number>): string {
