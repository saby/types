 ...
 * @param date Дата, которую надо перевести в другую таймзону.
 * @param timeZoneOffset Cмещение часового пояса относительно текущей часового пояса UTC в минутах.
 * @public
 */
