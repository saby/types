 ...
 * <ul>
 *    <li>{@link Types/chain:Abstract#each each}</li>
 *    <li>{@link Types/chain:Abstract#map map}</li>
 *    <li>{@link Types/chain:Abstract#reduce reduce}</li>
 *    <li>{@link Types/chain:Abstract#filter filter}</li>
 *    <li>{@link Types/chain:Abstract#reject reject}</li>
 *    <li>{@link Types/chain:Abstract#pluck pluck}</li>
 *    <li>{@link Types/chain:Abstract#sort sort}</li>
 *    <li>{@link Types/chain:Abstract#reverse reverse}</li>
 *    <li>{@link Types/chain:Abstract#group group}</li>
 *    <li>{@link Types/chain:Abstract#union union}</li>
 *    <li>{@link Types/chain:Abstract#concat concat} - </li>
 *    <li>{@link Types/chain:Abstract#count count}</li>
 *    <li>{@link Types/chain:Abstract#first first}</li>
 *    <li>{@link Types/chain:Abstract#last last}</li>
 *    <li>{@link Types/chain:Abstract#uniq uniq}</li>
 *    <li>{@link Types/chain:Abstract#max max}</li>
 *    <li>{@link Types/chain:Abstract#min min}</li>
 *    <li>{@link Types/chain:Abstract#invoke invoke}</li>
 *    <li>{@link Types/chain:Abstract#zip zip}</li>
 *    <li>{@link Types/chain:Abstract#zipObject zipObject}</li>
 *    <li>{@link Types/chain:Abstract#flatten flatten}</li>
 * </ul>
 *
...
export default function factory<T, U>(
    ...
    if (source instanceof Abstract) {
        return source;
    } else if (source && (source as IEnumerable<T, U>)['[Types/_collection/IEnumerable]']) {
