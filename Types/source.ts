...
export { default as Local, LOCAL_MOVE_POSITION, MemoryFilterFunction } from './_source/Local';
...
export { default as Remote, IProviderOptions, ICacheParameters } from './_source/Remote';
