...
import { InnerFunction } from './interface';
 ...
 * </ol>
 *
 * См. также функцию {@link Types/function:debounce debounce} которая позволяет игнорировать вызовы функции до тех пор, пока пока они не перестанут повторяться в течение указанного периода.
 *
 ...
 * @param last Выполнить последний вызов по окончании задержки
