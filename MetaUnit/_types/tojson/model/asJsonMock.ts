export default [
    ...
    },
    {
        ...
        editorProps:
            '{"markerItems":[{"id":"primary"},{"id":"brand"},{"id":"info"},{"id":"danger"},{"id":"success"},{"id":"unaccented"},{"id":"warning"}],"backgroundItems":[{"id":"default"},{"id":"primary"},{"id":"brand"},{"id":"info"},{"id":"danger"},{"id":"success"},{"id":"unaccented"},{"id":"warning"}],"titleItems":[{"id":"label"},{"id":"primary"},{"id":"secondary"},{"id":"info"},{"id":"danger"},{"id":"success"},{"id":"unaccented"},{"id":"warning"}],"backgroundCaption":"Фон","markerCaption":"Иконка","titleCaption":"Заголовок"}',
    ...
    },
    {
        ...
        defaultValue:
            '{"colors":{"marker":"success","background":"success","title":"label"},"widgetTitle":"Счётчик компаний"}',
