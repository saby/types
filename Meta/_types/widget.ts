import type { IMeta, ISerialized } from './baseMeta';
...
> extends ObjectMeta<T, ComponentPropsInterface> {
     ...
     * @param attributes
     */
    attachedAttributes(attributes: TAttachedInterface): this {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore TODO поправть типы
        return this.clone({ attachedAttributes: attributes });
    }
    ...
    getAttachedAttributes(
        ...
        return this._attachedAttributes[attributeName];
    }
