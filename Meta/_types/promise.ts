...
> extends IMeta<RuntimeInterface> {
     ...
     * @see IMeta
     */
    readonly result?: IMeta<ResolvedRuntimeInterface> | Meta<ResolvedRuntimeInterface> | null;
}
...
> extends Meta<RuntimeInterface> {
     ...
     */
    required(): PromiseMeta<Exclude<RuntimeInterface, undefined>, ResolvedRuntimeInterface> {
     ...
     * @see PromiseMeta.required
     */
    optional(): PromiseMeta<Exclude<RuntimeInterface, undefined>, ResolvedRuntimeInterface> {
...
>(descriptor: any): descriptor is IPromiseMeta<RuntimeInterface, ResolvedRuntimeInterface> {
