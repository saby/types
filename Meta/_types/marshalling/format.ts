import type { IMetaInfo, Meta, IComplexEditor } from '../baseMeta';
import type { ArrayMeta } from '../array';
import type { VariantMeta } from '../variant';
import type { EnumMeta } from '../enum';
...
export type TMetaJsonSingle = TInfo & { is: MetaClass } & Partial<
        {
            ...
            styles: TJsonValue<[TPropName, [TMetaId, TPropName][]][]>;
            parent: string;
            preview: string;
            designEditorAS: boolean;
            originId?: string;
            complexEditors?: TJsonValue<IComplexEditor[]>;
        } & ConverterUtils
    >;
...
export type TMetaJsonNewSingle = {
    ...
    id?: TMetaId;
    inherits?: string[];
    elements?: TMetaElements[];
};

export interface TMetaElements {
