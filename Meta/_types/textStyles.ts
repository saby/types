...
export const BorderType = ObjectType.id('Border')
    ...
    .editor('ThemeConstructor/styleEditors:BorderEditor');
...
const TextStyleTypeProperties = ObjectType.id('TextStyleTypeProperties').properties({
...
export const TextStyleType = StyleType.id('TextStyle')
    .properties(
        TextStyleTypeProperties.editor(
            'ThemeConstructor/styleEditors:FontStyleEditor'
        ).getProperties()
    )
    .designtimeEditor('ThemeConstructor/controls:FontStyleDesignTimeEditor');
...
/**
 * Метатип "Стиль текстового контейнера"
 * @public
 */
