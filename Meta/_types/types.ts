...
export const WidgetType = new WidgetMeta<object>({
    ...
    styles: {
        ...
        minHeight: CSSType.title(rk('Min высота')).optional().hidden(),
        maxHeight: CSSType.title(rk('Max высота')).optional().hidden(),
        width: CSSType.title(rk('Ширина')).optional().hidden(),
        minWidth: CSSType.title(rk('Min ширина')).optional().hidden(),
        maxWidth: CSSType.title(rk('Max ширина')).optional().hidden(),
    } as TStyleAttributes,
});
/**
 * Мета-тип "ресурс".
