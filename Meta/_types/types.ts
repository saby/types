 ...
 * @see IVariantMeta
 */
export const VariantType = new VariantMeta<Record<string, object>>({
 ...
 * @see IEnumMeta
 */
export const EnumType = new EnumMeta<Record<string, object>>({
    is: MetaClass.enum,
    id: 'enum',
...
export const WidgetType = new WidgetMeta<object>({
    ...
    id: 'widget',
    styles: {
        height: CSSType.title(rk('Высота')).optional().group('Размер', '').hidden(),
        minHeight: CSSType.title(rk('Min высота')).optional().group('Размер', '').hidden(),
        maxHeight: CSSType.title(rk('Max высота')).optional().group('Размер', '').hidden(),
        width: CSSType.title(rk('Ширина')).optional().group('Размер', '').hidden(),
        minWidth: CSSType.title(rk('Min ширина')).optional().group('Размер', '').hidden(),
        maxWidth: CSSType.title(rk('Max ширина')).optional().group('Размер', '').hidden(),
    } as TStyleAttributes,
});
/**
 * Мета-тип "ресурс".
 ...
 * @see IVariantMeta
 */
export const ResourceType = new VariantMeta<Record<string, object>>({
    is: MetaClass.variant,
    id: 'resource',
    invariant: 'type',
    inherits: ['variant'],
