 ...
 * @see IEnumMeta
 */
export const EnumType = new EnumMeta<object>({
    is: MetaClass.enum,
    id: 'enum',
 ...
 * @see IFlagsMeta
 */
export const FlagsType = new FlagsMeta<object>({
    is: MetaClass.flags,
    id: 'flags',
});
...
export const WidgetType = new WidgetMeta<object>({
    ...
    id: 'widget',
    styles: {
        height: CSSType.id('base_height')
            .title(rk('Высота'))
            .optional()
            .group('Размер', '')
            .hidden(),
        minHeight: CSSType.id('base_minHeight')
            .title(rk('Min высота'))
            .optional()
            .group('Размер', '')
            .hidden(),
        maxHeight: CSSType.id('base_maxHeight')
            .title(rk('Max высота'))
            .optional()
            .group('Размер', '')
            .hidden(),
        width: CSSType.id('base_width').title(rk('Ширина')).optional().group('Размер', '').hidden(),
        minWidth: CSSType.id('base_minWidth')
            .title(rk('Min ширина'))
            .optional()
            .group('Размер', '')
            .hidden(),
        maxWidth: CSSType.id('base_maxWidth')
            .title(rk('Max ширина'))
            .optional()
            .group('Размер', '')
            .hidden(),
 ...
 * @public
 */
export const StyleType = ObjectType.id('Style');
