 ...
 * @see IMeta
 */
export interface IArrayMeta<RuntimeInterface,
...
> extends Meta<RuntimeInterface> {
     ...
     */
    constructor(
        descriptor: IArrayMeta<RuntimeInterface, ItemRuntimeInterface> & { defaultValue?: ItemRuntimeInterface[] } = {
            is: MetaClass.array
        }
    ) {
        super(descriptor);
     ...
     */
    of<NewItemRuntimeInterface>(arrayOf: Meta<NewItemRuntimeInterface>): ArrayMeta<NewItemRuntimeInterface[]> {
        if (this._arrayOf === arrayOf as unknown) {
            return this as any;
        }
        return this.clone<
            ArrayMeta<NewItemRuntimeInterface[]>,
            IArrayMeta<NewItemRuntimeInterface[]>>({ arrayOf });
    }
