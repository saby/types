 ...
 * @see FunctionMeta
 */
export type Metas<A = void, B = void, C = void, D = void, E = void> = A extends void
    ? []
    : B extends void
    ? [Meta<A>]
    : C extends void
...
> extends IMeta<RuntimeInterface> {
    readonly is: MetaClass.function | MetaClass.rpc;
...
> extends Meta<RuntimeInterface> {
     ...
     * @see FunctionMeta.optional
     */
    optional(): FunctionMeta<Exclude<RuntimeInterface, undefined>, R, A, B, C, D, E> {
