...
import type { IPropertyEditorProps } from './components';
...
export interface IControlDesignerProps<T> extends IPropertyEditorProps<T> {
    ...
    /** Видимость рантайма при показанном дизайнтайме */
    runtimeVisibility: 'default' | 'hidden';

    /** Определяет необходимость наследования стилей из рантайма */
