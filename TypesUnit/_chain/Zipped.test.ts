...
describe('Types/_chain/Zipped', () => {
    ...
    describe('.getEnumerator()', () => {
        ...
        test('should return an enumerator with zipped items', () => {
            const itemsMap = ['1', '2'];
            const expectData = [
                ['one', '1'],
                ['two', '2'],
        ...
        test('should return an enumerator with IEnumerable-zipped items', () => {
        ...
        test('should return an enumerator with zipped items and reset it', () => {
            const itemsMap = ['1', '2'];
            const expectData = [
                ['one', '1'],
                ['two', '2'],
