...
describe('Types/_chain/Sorted', () => {
    ...
    describe('.getEnumerator()', () => {
        test('should return a valid enumerator for Array', () => {
            //@ts-ignore
        ...
        test('should return a valid enumerator for Object', () => {
            //@ts-ignore
        ...
        test('should enum values in direct order for Array', () => {
            //@ts-ignore
            const chain = new Sorted(prevArray);
            const enumerator = chain.getEnumerator();
            ...
            while (enumerator.moveNext()) {
                expect(enumerator.getCurrent()).toBe(sortedItems[index]);
        ...
        test('should enum pairs in direct order for Object', () => {
            //@ts-ignore
            const chain = new Sorted(prevObject);
            const enumerator = chain.getEnumerator();
            ...
            while (enumerator.moveNext()) {
                expect(enumerator.getCurrent()).toBe(sortedItems[index]);
                //@ts-ignore
                expect(enumerator.getCurrentIndex()).toBe(pairs[enumerator.getCurrent()]);
                index++;
            }
            expect(index).toBe(keys.length);
        });

        test('should enum strings in direct order for Array', () => {
        ...
        test('should enum objects in direct order for Array', () => {
        ...
        test('should enum numbers in direct order use compareFunction for Array', () => {
            const sortedItems = itemsArray.slice();
            //@ts-ignore
            const compare = (a, b) => {
                return a - b;
        ...
        test('should enum numbers in reverse order', () => {
            const sortedItems = itemsArray.slice();
            //@ts-ignore
            const compare = (a, b) => {
                return b - a;
        ...
        test('should enum numbers in direct order after reset', () => {
            const sortedItems = itemsArray.slice();
            //@ts-ignore
            const chain = new Sorted(prevArray);
            const enumerator = chain.getEnumerator();
