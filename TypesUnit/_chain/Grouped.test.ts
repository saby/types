...
describe('Types/_chain/Grouped', () => {
    describe('.getEnumerator()', () => {
        ...
        test('should group array of string', () => {
        ...
        test('should group object of string', () => {
        ...
        test('should group by given property', () => {
            const items = [{ id: 1 }, { id: 2 }, { id: 1 }, { id: 3 }];
            const prev = new ArrayMock(items);
            const chain = new GroupedChain(prev, 'id');
            const enumerator = chain.getEnumerator();
            const expectedKeys = [1, 2, 3];
            const expectedValues = [[items[0], items[2]], [items[1]], [items[3]]];
        ...
        test('should group and map by given property', () => {
            const items = [
                { id: 1, value: 'one' },
                { id: 2, value: 'two' },
                { id: 1, value: 'three' },
        ...
        test('should group by given key handler', () => {
        ...
        test('should group by given map handler', () => {
            const items = [1, 2, 3, 4, 5];
            const prev = new ArrayMock(items);
