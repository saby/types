...
describe('Types/_chain/Enumerable', () => {
    ...
    describe('.getEnumerator()', () => {
        test('should return enumerator with all properties', () => {
    ...
    describe('.each()', () => {
        test('should return all properties and values', () => {
            const keys = Object.keys(data);
            let index = 0;
    ...
    describe('.toArray()', () => {
        test('should return all properties for Record', () => {
            expect(chain.toArray()).toEqual(Object.keys(data));
        });

        test('should return all items for List', () => {
    ...
    describe('.toObject()', () => {
        test('should return equal object for Record', () => {
