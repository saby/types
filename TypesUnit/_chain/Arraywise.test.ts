...
describe('Types/_chain/Arraywise', () => {
    ...
    describe('.start', () => {
        test('should return itself for first element', () => {
            expect(chain.start).toBe(chain);
        });

        test('should return first element for second element', () => {
    ...
    describe('.value()', () => {
        test('should return all items as array', () => {
        ...
        test('should pass arguments to the factory', () => {
            //@ts-ignore
            const factory = (...args) => {
                return args;
            };
    ...
    describe('.toObject()', () => {
        test('should return array-like items', () => {
    ...
    describe('.reduce()', () => {
        ...
        test('should return summary with offset', () => {
            const items = [1, 2, 3];
            const chain = new Arraywise(items);
            const result = chain.reduce((prev, curr) => {
                //@ts-ignore
    ...
    describe('.reduceRight()', () => {
        ...
        test('should return division with offset', () => {
            const items = [5, 2, 100];
            const chain = new Arraywise(items);
            const result = chain.reduceRight((prev, curr) => {
                //@ts-ignore
    ...
    describe('.map()', () => {
        test('should convert chain to the indices', () => {
            let index = 0;
            chain
                //@ts-ignore
                .map((item, itemIndex) => {
        ...
        test('should convert chain to the pairs', () => {
            let index = 0;
            chain
                .map((item, itemIndex) => {
    ...
    describe('.zip()', () => {
        test('should zip the collections', () => {
            const expectData = [
                ['one', 1, true],
                ['two', 2, true],
                ['three', 3, false],
    ...
    describe('.pluck()', () => {
        test('should convert chain to the array of sting', () => {
    ...
    describe('.concat()', () => {
        test('should concat the chain with the array', () => {
            const items = [1, 2, 3];
            const concat1 = [4, 5];
            const concat2 = [6];
    ...
    describe('.flatten()', () => {
        test('should convert nested chain to the array', () => {
    ...
    describe('.uniq()', () => {
        ...
        test('should return unique items for large array', () => {
        ...
        test('should return items with unique property values', () => {
            const items = [
                { id: 1, title: 'a' },
                { id: 2, title: 'b' },
                { id: 3, title: 'a' },
        ...
        test('should return items with unique property values from toArray', () => {
            const items = [
                { id: 1, title: 'a' },
                { id: 2, title: 'b' },
                { id: 3, title: 'a' },
    ...
    describe('.union()', () => {
        test('should union with the array', () => {
            const items = [1, 2, 3];
    ...
    describe('.reject()', () => {
        test('should filter chain in negative logic', () => {
    ...
    describe('.where()', () => {
        test('should filter chain in "and" logic', () => {
            const items = [
    ...
    describe('.first()', () => {
        ...
        test('should return first "n" items', () => {
