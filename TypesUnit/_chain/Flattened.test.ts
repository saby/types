...
describe('Types/_chain/Flattened', () => {
    ...
    describe('.getEnumerator()', () => {
        ...
        test('should return an enumerator with flat items', () => {
            const chain = new FlattenedChain(prev);
            const enumerator = chain.getEnumerator();
            let index = 0;
        ...
        test('should return an enumerator with flat items after reset', () => {
            const chain = new FlattenedChain(prev);
            const enumerator = chain.getEnumerator();
        ...
        test('should return an enumerator with nesting arrays', () => {
        ...
        test('should return an enumerator which works well with empty arrays by the way', () => {
            const items = [[], 1, [2, 3]];
        ...
        test('should return an enumerator with nesting IEnumerable', () => {
