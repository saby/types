...
describe('Types/_collection/RecordSet', () => {
    ...
    describe('.getEnumerator()', () => {
        ...
        it('should return records with state "Unchanged"', () => {
            ...
            while (enumerator.moveNext()) {
                assert.strictEqual(
                    enumerator.getCurrent().getState(),
    ...
    describe('.getFormat()', () => {
        ...
        it('should build the record format from declarative option', () => {
            ...
            format.each((item, index) => {
                ...
                assert.strictEqual(
                    String(item.getType()).toLowerCase(),
    ...
    describe('.addField()', () => {
        it('should add the field from the declaration for JSON adapter', () => {
            ...
            assert.strictEqual(
                format.at(index).getDefaultValue(),
                fieldDefault
            );
        ...
        it('should add the field from the instance', () => {
            ...
            assert.strictEqual(
                rs.getFormat().at(index).getDefaultValue(),
                fieldDefault
            );
            rs.each((record) => {
                assert.strictEqual(record.get(fieldName), fieldDefault);
                assert.strictEqual(
                    record.getRawData()[fieldName],
                    fieldDefault
                );
            });
        });
    ...
    describe('.append()', () => {
        ...
        it('should add model with the same format as external model has', () => {
            ...
            assert.isTrue(
                recordSet.at(0).getFormat().isEqual(record.getFormat())
            );
        });
    });
    ...
    describe('.add()', () => {
        ...
        it('should add record to empty recordset and keep own format', () => {
            ...
            assert.equal(
                recordset.getFormat().getCount(),
                rawFormatData.s.length
            );
        });
    });
