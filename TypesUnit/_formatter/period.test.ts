...
describe('Types/_formatter/period', () => {
    ...
    const finishOfFirstQuarter = new Date(
        startYear,
        lastMonthOfFirstQuarter,
        firstDay
    );
    const finishOfThirdQuarter = new Date(
        startYear,
        lastMonthOfThirdQuarter,
        firstDay
    );
    const finishOfFirstQuarterAnotherYear = new Date(
        finishYear,
        lastMonthOfFirstQuarter,
        firstDay
    );
    ...
    const finishOfHalfYearAnotherYear = new Date(
        finishYear,
        lastMonthOfHalfYear,
        firstDay
    );
    ...
    describe('Compatibility', () => {
        ...
        const expectedList: testingTupleComp[] = [
            ...
            [
                ...
                anotherYear,
                Type.FullHalfYear,
                "I half year'18-II half year'19",
            ],
            ...
            [
                ...
                anotherMonth,
                Type.FullHalfYear,
                "I half year'18-II half year'18",
            ],
