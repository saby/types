...
describe('Types/_formatter/period', () => {
    ...
    describe('Compatibility', () => {
        ...
        const expectedList: testingTupleComp[] = [
            ...
            [commonStart, anotherYear, Type.FullQuarter, "Quarter I'18-Quarter IV'19"],
            [commonStart, anotherYear, Type.ShortQuarter, "QI'18-QIV'19"],
            [commonStart, anotherYear, Type.FullHalfYear, "Half I'18-Half II'19"],
            [commonStart, anotherYear, Type.ShortHalfYear, "HI'18-HII'19"],
            ...
            [commonStart, anotherMonth, Type.FullQuarter, "Quarter I'18-Quarter IV'18"],
            [commonStart, anotherMonth, Type.ShortQuarter, "QI'18-QIV'18"],
            [commonStart, anotherMonth, Type.FullHalfYear, "Half I'18-Half II'18"],
            [commonStart, anotherMonth, Type.ShortHalfYear, "HI'18-HII'18"],
            ...
            [commonStart, anotherDay, Type.FullQuarter, "Quarter I'18"],
            [commonStart, anotherDay, Type.ShortQuarter, "QI'18"],
            [commonStart, anotherDay, Type.FullHalfYear, "Half I'18"],
            [commonStart, anotherDay, Type.ShortHalfYear, "HI'18"],
        ];
    ...
    describe('Default configuration', () => {
        describe('full', () => {
            const testCase: ITestingTuple = {
                ...
                oneQuarter: [start, finishOfFirstQuarter, "Quarter I'21"],
                quartersOneYear: [start, finishOfThirdQuarter, "Quarters I-III'21"],
                quartersYears: [
                    start,
                    finishOfFirstQuarterAnotherYear,
                    "Quarter I'21-Quarter I'22",
                ],
                oneHalfYear: [start, finishOfHalfYear, "Half I'21"],
                halfYearsYears: [start, finishOfHalfYearAnotherYear, "Half I'21-Half I'22"],
        ...
        describe('short', () => {
            const testCase: ITestingTuple = {
                ...
                oneQuarter: [start, finishOfFirstQuarter, "QI'21"],
                quartersOneYear: [start, finishOfThirdQuarter, "QI-III'21"],
                quartersYears: [start, finishOfFirstQuarterAnotherYear, "QI'21-QI'22"],
                oneHalfYear: [start, finishOfHalfYear, "HI'21"],
                halfYearsYears: [start, finishOfHalfYearAnotherYear, "HI'21-HI'22"],
                oneYear: [start, start, '2021'],
                years: [start, finishAnotherYear, '2021-2022'],
    ...
    describe('i18n', () => {
        describe('for locale kk', () => {
            ...
            describe('default configuration', () => {
                ...
                describe('short', () => {
                    const testCase: ITestingTuple = {
                        oneDay: [start, start, "1 қаңт'21"],
                        daysOneMonth: [start, finishAnotherDay, '01.01.21-05.01.21'],
                        daysMonthsOneYear: [start, finishAnotherMonth, '01.01.21-01.07.21'],
                        daysMonthsYears: [start, finishAnotherYear, '01.01.21-01.01.22'],
                        oneMonth: [start, start, "Қаңт'21"],
                        monthsOneYear: [start, finishAnotherMonth, "Қаңт-Шіл'21"],
                        monthsYears: [start, finishAnotherYear, "Қаңт'21-Қаңт'22"],
                        ...
                        oneYear: [start, start, '2021'],
                        years: [start, finishAnotherYear, '2021-2022'],
                        openStartPeriod: [null, finishAnotherDay, "5 қаңт'21 дейін"],
                        openFinishPeriod: [finishAnotherDay, null, "5 қаңт'21 бастап"],
                        openStartPeriodTemplate: [null, finishAnotherDay, "5 қаңт'21 дейін"],
                        openFinishPeriodTemplate: [finishAnotherDay, null, "5 қаңт'21 бастап"],
                        allPeriod: [null, null, 'кезең бойы'],
                        today: [start, start, 'бүгін'],
                    };
