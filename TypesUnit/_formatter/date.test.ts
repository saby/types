    ...
    describe('constants', () => {
        describe('if there is special constant in locale config', () => {
            ...
            Object.keys(map).forEach((constant) => {
                const expected =
                    controller.currentLocaleConfig.date[map[constant]];
    ...
    describe('strategies', () => {
        ...
        describe('Default', () => {
            it('should return full date always', () => {
                ...
                assert.strictEqual(
                    format(new Date(2022, 7, 5, 11, 0, 0), config),
                    '05.08.22'
                );
                assert.strictEqual(
                    format(new Date(2022, 1, 5, 13, 0, 0), config),
                    '05.02.22'
                );
                assert.strictEqual(
                    format(new Date(2022, 9, 5, 11, 0, 0), config),
                    '05.10.22'
                );
            });
        });
