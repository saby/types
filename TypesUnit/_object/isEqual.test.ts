...
describe('Types/_object/isEqual', () => {
    ...
    it('should return true for string objects', () => {
        assert.isTrue(isEqual(new String(''), new String('')));
        assert.isTrue(isEqual(new String('a'), new String('a')));
    });

    it('should return false for string objects', () => {
        assert.isFalse(isEqual(new String('a'), new String('b')));
    });
    ...
    it('should return true for objects with dates', () => {
        assert.isTrue(
            isEqual({ a: new Date(1, 2, 3) }, { a: new Date(1, 2, 3) })
        );
    });

    it('should return false for objects with dates', () => {
        assert.isFalse(
            isEqual({ a: new Date(1, 2, 3) }, { a: new Date(1, 2, 4) })
        );
    });
