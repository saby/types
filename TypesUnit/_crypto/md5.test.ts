...
describe('Types/utils:Md5', () => {
    ...
    test('should hash a 64 byte string', () => {
        ...
        expect(md5.appendByteArray(arr).end()).toEqual(expectedResult);
    ...
    test('can handle UTF8 strings', () => {
        ...
        expect(md5.appendByteArray(arr).end()).toEqual('09d9d71ec8a8e3bc74e51ebd587154f3');
        ...
        md5 = new Md5();
        expect(md5.appendByteArray(arr).end()).toEqual('4664c02a4cf6b69392f8309b6d6256f5');
