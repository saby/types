    ...
    describe('.cast()', () => {
        ...
        context('for money', () => {
            ...
            it('should return passed value if precision less or equal 3 ', () => {
                ...
                assert.strictEqual(cast(1.2, format.getType(), { format }), 1.2);
            });
            ...
            it('should return formatted value if precision more then 3 ', () => {
                ...
                assert.strictEqual(cast(1.2, format.getType(), { format }), '1.2000');
            });
        ...
        context('for array', () => {
            it('should return an Array of String from Field', () => {
                ...
                assert.deepEqual(cast(array, format.getType(), { format }), ['foo', 'bar']);
            });
            ...
            it('should return an Array of Number from UniversalField', () => {
                ...
                assert.deepEqual(cast(array, format.type, { format }), [1, 2, 3]);
            });
            ...
            it('should cast elements type to string', () => {
                ...
                assert.deepEqual(cast(array, format.getType(), { format }), ['1', '2', '3', null]);
            });
            ...
            it('should return an Array from scalar', () => {
                ...
                assert.deepEqual(cast('foo', format.getType(), { format }), ['foo']);
            });
    ...
    describe('.serialize()', () => {
        ...
        context('for datetime, date and time', () => {
            it('should return a String with time zone for datetime', () => {
                ...
                assert.strictEqual(serialize(datetime, { format }), '2015-09-24 15:54:28.981+03');
            });
            ...
            it('should return a String without timezone for datetime and UniversalField', () => {
                ...
                assert.strictEqual(serialize(datetime, { format }), '2001-04-15 00:00:00');
            });
            ...
            it('should return a String without timezone if timezome offset contains not integer hours', () => {
                ...
                assert.strictEqual(serialize(datetime, { format }), '2001-01-01 10:20:30');
            ...
            it('should return a String for date', () => {
                ...
                assert.strictEqual(serialize(datetime, { format }), '2015-09-24');
            });
            ...
            it('should return a String for time without timezone', () => {
                ...
                assert.strictEqual(serialize(datetime, { format }), '15:54:28.981');
            });
        ...
        context('for timeinterval', () => {
            ...
            it('should return passed value', () => {
                ...
                assert.strictEqual(serialize('P10DT0H0M0S', { format }), 'P10DT0H0M0S');
                assert.isNull(serialize(null, { format }));
                assert.isUndefined(serialize(undefined, { format }));
            });
        });
