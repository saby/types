...
describe('Types/_entity/adapter/SbisRecord', () => {
    ...
    describe('.getFormat()', () => {
        ...
        it('should return Enum field format', () => {
            ...
            const adapter = new SbisRecord(data);
            const format =
                adapter.getFormat<fieldFormat.DictionaryField>('enum');
        ...
        it('should return Flags field format', () => {
            ...
            const adapter = new SbisRecord(data);
            const format =
                adapter.getFormat<fieldFormat.DictionaryField>('flags');
    ...
    describe('.getSharedFormat()', () => {
        ...
        it('should return Enum field format', () => {
            ...
            assert.deepEqual(
                (format.meta as IDictionaryMeta).dictionary,
                declaration.t.s
            );
            assert.isUndefined(
                (format.meta as IDictionaryMeta).localeDictionary
            );
        });
    ...
    describe('.addField()', () => {
        ...
        it('should add an Integer field', () => {
            ...
            assert.strictEqual(
                adapter.getData().s[fieldIndex].t,
                'Число целое'
            );
        });
