...
describe('Types/_entity/descriptor', () => {
    ...
    it('should return TypeError for not a Boolean value', () => {
        assert.instanceOf(
            descriptor(Boolean)({ testProp: null }, 'testProp', 'TestComponent'),
            TypeError
        );
        assert.instanceOf(
    ...
    it('should return TypeError for not a String value', () => {
        ...
        assert.instanceOf(
            descriptor(String)({ testProp: false }, 'testProp', 'TestComponent'),
            TypeError
        );
        assert.instanceOf(
    ...
    it('should return TypeError for not an Object value', () => {
        ...
        assert.instanceOf(
            descriptor(Object)({ testProp: false }, 'testProp', 'TestComponent'),
            TypeError
        );
        assert.instanceOf(
