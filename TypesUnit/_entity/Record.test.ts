...
describe('Types/_entity/Record', () => {
    ...
    describe('.set()', () => {
        ...
        it('should change value if it is RecordSet', () => {
            ...
            record.set('rs', newRs);
            assert.deepEqual(record.get('rs').getRawData(), newData);
        });
    ...
    describe('.isChanged()', () => {
        ...
        it('should deeply compare value object', () => {
            ...
            const record = new Record({
                rawData: {
                    [DATA_PROP]: { ...testObject },
                },
            });

            // set value
            record.set(DATA_PROP, {
                ...testObject,
                bar: 'new value',
            });

            assert.isTrue(record.isChanged(DATA_PROP));

            // revert old values but different object
            record.set(DATA_PROP, {
                ...testObject,
            });

            assert.isFalse(record.isChanged(DATA_PROP));
        });
    });
