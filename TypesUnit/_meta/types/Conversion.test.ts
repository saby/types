...
import { ArrayType, StringType, NumberType, DateType, ObjectType, WidgetType } from 'Types/meta';
import { convertValueOfMeta, findConvertableTypes, isEqual as metaIsEqual } from 'Types/reflect';
...
describe('Types/_meta/conversion', () => {
    describe('Conversion', () => {
        ...
        describe('findConvertableTypes()', () => {
            it('Поиск доступных для конвертации мета-типов (тривиальная конвертируемость)', async () => {
