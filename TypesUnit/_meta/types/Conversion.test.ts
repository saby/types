...
describe('Types/_meta/conversion', () => {
    describe('Conversion', () => {
        ...
        describe('findConvertableTypes()', () => {
            it('Поиск доступных для конвертации мета-типов', () => {
                ...
                const widgetArrayConvertableTypes = findConvertableTypes([widget4, widget4, widget4], MetaStore);
                ...
                expect(
                    !!widget3CustomConvertableTypes.find((w) => w.getId() === 'Types/widgetWithArray')
                ).equal(false);
        ...
        describe('convertValueOfMeta()', () => {
            it('Конвертация мета-типов', () => {
                ...
                expect(
                    isEqual(convertValueOfMeta(widget1Val, widget1, widget2), { name: 'Vlad', age: 30 })
                ).equal(true);

                expect(isEqual(convertValueOfMeta(widget1Val, widget1, widget1), widget1Val)).equal(true);

                expect(
                    isEqual(convertValueOfMeta(widget1Val, widget1, widget4), { name: 'Vlad', age: 30 })
                ).equal(true);

                expect(
                    isEqual(convertValueOfMeta(widget2Val, widget2, widget1), { name: 'Ivan', age: 20 })
                ).equal(true);

                expect(isEqual(convertValueOfMeta(widget3Val, widget3, widget4), {})).equal(true);

                expect(
                    isEqual(convertValueOfMeta(widget4Val, widget4, widget1), { name: 'Max', age: 25 })
                ).equal(true);
            });
        });
    });
