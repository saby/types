...
import { ObjectComponentLoaderWithProps } from 'Types/_meta/components';
...
describe('Types/_meta/meta', () => {
    describe('ObjectMeta', () => {
        ...
        describe('getEditor()', () => {
            it('возвращает экземпляр класса `ObjectComponentLoaderWithProps`', () => {
                const result = new ObjectMeta({
                    is: MetaClass.object,
                    attributes: {},
                    editor: {},
                });
                expect(result.getEditor()).instanceOf(ObjectComponentLoaderWithProps);
            });
        });
        ...
        describe('getEditor()', () => {
            it('возвращает редактор - экземпляр класса `ObjectComponentLoaderWithProps`', () => {
                ...
                expect(result).instanceOf(ObjectComponentLoaderWithProps);
