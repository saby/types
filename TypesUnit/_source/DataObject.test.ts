...
describe('Types/source:DataObject', () => {
            ...
            .mockReturnValue({
                ...
                call: (command: string, data: Record<string, unknown>, _: object) => {
                    ...
                    switch (command) {
                        case 'Read':
                            // @ts-ignore
                            if (data.ID === EXISTS_ID || data.ID === null) {
                                // @ts-ignore
    ...
    describe('.read()', () => {
        describe('when objectName exists', () => {
            ...
            test('should generate a valid request', async () => {
                return source
                    .read(EXISTS_ID, {
                        fields: ['FullName', 'Age'],
                    })
            ...
            test('should send the object identifier as a string', async () => {
                return source
                    .read(123, {
                        fields: [],
                    })
            ...
            test('null identifier should not be converted to a string', async () => {
                return source
                    .read(null, {
                        fields: [],
                    })
                    .then(() => {
                        const args = lastCallArgs;
                        expect(args.ID).toEqual(null);
                    });
            });

            test('should require Id field for empty fields', async () => {
                return source
                    .read(EXISTS_ID, {
                        fields: [],
                    })
            ...
            test('should pass additional parameters to call', async () => {
                return source
                    .read(EXISTS_ID, {
                        fields: ['SomeField'],
                        parameters: {
            ...
            test('should pass ServiceId to call', async () => {
                return source
                    .read(EXISTS_ID, {
                        fields: ['SomeField'],
                        parameters: {
            ...
            test('should pass RegulationId to call', async () => {
                return source
                    .read(EXISTS_ID, {
                        fields: ['SomeField'],
                        parameters: {
            ...
            test('should pass partial parameter to call', async () => {
                return source
                    .read(EXISTS_ID, {
                        fields: ['SomeField'],
                        parameters: {
        ...
        describe("when objectName doesn't exists", () => {
            test('should throw error on read', () => {
    ...
    describe('.update()', () => {
        ...
        describe('when objectName exists', () => {
            ...
            test('should only update the id field if there are no other changed fields', async () => {
                return source
                    .update(updateModel, {
                        updateOnlyChanged: true,
                    })
            ...
            test('should pass partial parameter to update call', async () => {
                return source
                    .update(updateModel, {
                        parameters: {
                            ServiceId: '111',
        ...
        describe('when objectName doesnt exists', () => {
            test('should throw error on update', () => {
                const service = new DataObject({
                    // @ts-ignore
                    objectName: undefined,
                });
